...
class Main extends React.Component {
  state = {
    ...
    total_pages: 1,
    page: 1,
    url: `https://api.themoviedb.org/3/genre/movie/list?api_key=a1ea2d20593aa9f59c79dfa09a636ce6&language=en-US`,
    moviesUrl: `https://api.themoviedb.org/3/discover/movie?api_key=a1ea2d20593aa9f59c79dfa09a636ce6&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1`,
    genre: "Comedy",
    genres: [],
    year: {
      label: "year",
  ...
  generateUrl = () => {
    ...
    const moviesUrl = `https://api.themoviedb.org/3/discover/movie?` +
      `api_key=a1ea2d20593aa9f59c79dfa09a636ce6&` +
